...
project = 'abm'
copyright = '2019, Cillian Berragan'
...
latex_documents = [
    (master_doc, 'abm.tex', 'abm Documentation',
     'Cillian Berragan', 'manual'),
]
...
man_pages = [
    (master_doc, 'abm', 'abm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'abm', 'abm Documentation',
     author, 'abm', 'One line description of project.',
     'Miscellaneous'),
]
